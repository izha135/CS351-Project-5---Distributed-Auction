...
public class User {
    ...
    private static List<AuctionHouseUser> entireHousesList = new ArrayList<>();

    // FIXME: everything moved to the GUI (in the userGUI package)
...
//                        }
//
//                        entireHousesList.add(new AuctionHouseUser(Integer
